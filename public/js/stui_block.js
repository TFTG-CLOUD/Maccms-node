...
var qrcode1 = typeof qrcode1 !== "undefined" ? qrcode1 : "1";
//右侧悬浮二维码，1自动生成（当前页面二维码），填写路径将加载指定图片（建议尺寸150*150px）例：/statics/img/wxcode.png

var qrcode2 = typeof qrcode2 !== "undefined" ? qrcode2 : "1";
//内容页二维码，1自动生成（当前页面二维码），填写路径将加载指定图片（建议尺寸160*160px）例：/statics/img/wxcode.png

var qrTargetUrl = typeof qrTargetUrl !== "undefined" ? qrTargetUrl : "";
//二维码指定跳转地址，留空时默认使用当前页面地址
...
var stui = {
	...
	'images': {//图片处理
		...
		'qrcode': function() {
			var qrText = qrTargetUrl || stui.browser.url;
			if(qrcode1==1){
				if($("#qrcode").length){

...
test('shouldBypassPageCache skips non-front or non-html-like requests', () => {
  ...
  assert.equal(shouldBypassPageCache({ method: 'GET', path: '/vod/play/id/1/sid/1/nid/1.html', originalUrl: '/vod/play/id/1/sid/1/nid/1.html' }), false);
  assert.equal(shouldBypassPageCache({ method: 'GET', path: '/index.php/vod/play/id/1/sid/1/nid/1.html', originalUrl: '/index.php/vod/play/id/1/sid/1/nid/1.html' }), false);
});
